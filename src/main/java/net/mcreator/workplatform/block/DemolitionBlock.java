...
import net.mcreator.workplatform.procedures.Demolition1Procedure;

public class DemolitionBlock extends Block {
	public DemolitionBlock() {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		Demolition1Procedure.execute(world, x, y, z);
