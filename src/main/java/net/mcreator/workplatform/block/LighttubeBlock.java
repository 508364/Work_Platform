...
public class LighttubeBlock extends Block implements SimpleWaterloggedBlock {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;
	public static final EnumProperty<AttachFace> FACE = FaceAttachedHorizontalDirectionalBlock.FACE;
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	public LighttubeBlock() {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(FACING)) {
			default -> switch (state.getValue(FACE)) {
				case FLOOR -> box(0, 6, 6, 16, 10, 10);
				case WALL -> box(0, 6, 6, 16, 10, 10);
				case CEILING -> box(0, 6, 6, 16, 10, 10);
			};
			...
			case EAST -> switch (state.getValue(FACE)) {
				case FLOOR -> box(6, 6, 0, 10, 10, 16);
				case WALL -> box(6, 6, 0, 10, 10, 16);
				case CEILING -> box(6, 6, 0, 10, 10, 16);
			};
